<template>
  <p ref="wordsRef" class="word" :class="{ active: props.wordIndex === testState.currentWordElementIndex }">
    <span v-for="(letter, letterIndex) in props.word" :key="`${letter}-${letterIndex}`" :class="[
