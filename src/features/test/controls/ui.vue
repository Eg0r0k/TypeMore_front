  ...
  <div class="controls">
    <div class="controls__presets">
      <div class="preset-group">
        <Button v-for="mode in modes" :key="mode" color="shadow" size="s"
          :class="{ active: configStore.config.mode === mode }" @click="handleModeChange(mode)">
          {{ mode }}
        </Button>
      </div>
      <div class="preset-group">
        <Button v-for="preset in timePresets" :key="preset" color="shadow" size="s" :class="{
      ...
      <div class="preset-group">
        <Button v-for="preset in wordPresets" :key="preset" color="shadow" size="s" :class="{
