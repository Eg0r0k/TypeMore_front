<template>
    ...
    <div class="profile__settings-wrapper">
        <Button class="profile__settings-button" buttonLabel="•••" size="s" color="gray" @click="openDropDown"
            :aria-expanded="isDropdownOpen" aria-haspopup="true" aria-controls="profile-settings-dropdown">
            •••
        </Button>
        <ul v-if="isDropdownOpen" id="profile-settings-dropdown" class="profile__settings-dropdown" role="menu"
