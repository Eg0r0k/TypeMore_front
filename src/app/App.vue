  ...
  <Transition name="fade" mode="out-in">
    <div v-if="!testState.isLoading" class="wrapper" role="main">
      ...
      <div class="customBackground">
        <img :src="configStore.config.backgroundImg" draggable="false"
          onerror="console.log('inplement alert on failed loading image [App.vue]')" alt="Background Image"
          style="width: calc(100% + 0rem); height: calc(100% + 0rem); left: 0rem; top: 0rem; position: absolute; user-select:none; object-fit: cover;">
      </div>
...
import { defineAsyncComponent, onBeforeMount, onMounted, onUnmounted, provide, ref, Teleport } from 'vue'
